...
while True:
    ...
    img = cv2.putText(img, str('pError:' + str(pError)), (0, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 100, 0), 1,
                      cv2.LINE_AA)
    img = cv2.putText(img, str('pError_y:' + str(pError_y)), (0, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 100, 0), 1,
                      cv2.LINE_AA)
    img = cv2.putText(img, str('Area:' + str(face_info[1])), (0, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 100, 0), 1,
                      cv2.LINE_AA)
